    ...
    <div className="space-y-6">
      ...
      <div className="glass p-5 sm:p-6 space-y-5">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            onClick={reset}
            className="inline-flex items-center gap-2 px-3 h-9 rounded-lg border border-hairline-strong bg-tint-1 text-foreground/85 text-xs hover:bg-tint-2 transition"
          >
